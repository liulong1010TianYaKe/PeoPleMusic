...
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 70000
        labelSize = [label.text boundingRectWithSize:CGSizeMake(labelSize.width, self.bounds.size.height - 40) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:[NSDictionary dictionaryWithObjectsAndKeys:label.font, NSFontAttributeName, nil] context:NULL].size;
#else
        labelSize = [label.text sizeWithFont:label.font constrainedToSize:CGSizeMake(labelSize.width, self.bounds.size.height - 40)];
#endif
