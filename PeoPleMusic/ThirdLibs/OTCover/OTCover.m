...
- (OTCover*)initWithTableViewWithHeaderImage:(UIImage*)headerImage withOTCoverHeight:(CGFloat)height withFrame:(CGRect)rect{
    self = [[OTCover alloc] initWithFrame:rect];
    
    self.headerImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, rect.size.width, height)];
    ...
    self.tableView.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, rect.size.width, height)];
...
- (OTCover*)initWithTableViewWithHeaderView:(UIView *)headerView withOTCoverHeight:(CGFloat)height withFrame:(CGRect)rect {
    ...
    self.headerView.frame = CGRectMake(0, 0, rect.size.width, height);
...
- (void)animationForTableView{
    ...
    if (self.tableView.contentOffset.y > 0) {
        ...
        self.headerImageView.frame = CGRectMake(0,-offset/3.0, self.frame.size.width, self.OTCoverHeight);
        self.headerView.frame = CGRectMake(0,-offset/3.0, self.frame.size.width, self.OTCoverHeight);
    }
    else {
