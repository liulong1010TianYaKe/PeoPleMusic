...
- (void)animationForTableView{
    ...
    if (offset > 0) {
        ...
        _expandView.frame = CGRectMake(0, offset - _scrollView.contentInset.top - (_expandHeight - _scrollView.contentInset.top), 320, _expandHeight);
    }
    else {
        _expandView.frame = CGRectMake(offset,offset - _scrollView.contentInset.top - (_expandHeight - _scrollView.contentInset.top), 320+ (-offset) * 2, _expandHeight + (-offset));
    }
}
