...
@interface BasicsTableViewController ()<UIAlertViewDelegate>
...
@implementation BasicsTableViewController
...
- (void)changePageControlImage:(UIPageControl *)pageControl
{
    ...
    dispatch_once(&onceToken, ^{
        imgCurrent = [UIImage imageNamed:@"bg_chuzhuang_dian_shixin"];
        imgOther = [UIImage imageNamed:@"bg_chuzhuang_dian_kongxin"];
    });
